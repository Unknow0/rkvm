...
pub struct WriterLinuxBuilder {
    evdev: Evdev,
}

impl WriterLinuxBuilder {
...
impl WriterBuilderPlatform for WriterLinuxBuilder {
    type Writer = WriterLinux;
    ...
    async fn build(self) -> Result<Self::Writer, Error> {
        WriterLinux::from_evdev(&self.evdev).await
    }
}
